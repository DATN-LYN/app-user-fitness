...
class UpsertSupportPage extends ConsumerStatefulWidget {
  const UpsertSupportPage({
    super.key,
  });

  @override
  ConsumerState<UpsertSupportPage> createState() => _SupportPageState();
}

class _SupportPageState extends ConsumerState<UpsertSupportPage> {
  XFile? image;
  bool loading = false;
      ...
      await showDialog(
        ...
        builder: (dialogContext) {
          ...
          return ConfirmationDialog(
            titleText: i18n.support_CreateTitle,
            contentText: i18n.support_CreateDes,
            onTapPositiveButton: () async {
              ...
              final request = GUpsertSupportReq(
                (b) => b
                  ...
                  ..vars.input.content = formValue['content']
                  ..vars.input.status = 1,
              );
                  ...
                  await showDialog(
                    ...
                    builder: (context) {
                      return ConfirmationDialog(
                        ...
                        contentText: i18n.support_CreateSuccess,
                        image: const Icon(
